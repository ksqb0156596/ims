    ...
    render : function () {
        ...
        if(this.state.visible){
            _Modal = <Modal ref="modal"
                            ...
                            title="编辑平台" onOk={this.handleOk} onCancel={this.handleCancel}
                            footer={[
            ...
            <Row type="flex">
                <Col sm={8}>
                    <FormItem
                        ...
                        wrapperCol={{ span: 14 }}
                    >
                        <Input placeholder="请输入平台名" size="default" id="search_name" value={searchModal.name} onChange={this.props.handleChange}/>
                    </FormItem>
                </Col>
            </Row>
            <Row>
